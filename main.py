...
from StarcoolMod import StarcoolMod
...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.rainbow, '@StarcoolMod'))
    print(Colorate.Horizontal(Colors.rainbow, f'𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦: @{__CHANNEL_USERNAME__}'))
    print(Colorate.Horizontal(Colors.rainbow, f'𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦: @{__GROUP_USERNAME__}'))
    print(Colorate.Horizontal(Colors.rainbow, '====================================='))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cpm = StarcoolMod(acc_access_key)
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if status == 0:
                    print(Colorate.Horizontal(Colors.rainbow, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.rainbow, '======================================'))
                    print(Colorate.Horizontal(Colors.rainbow, f'INFO: In order to tweak this account with StarcoolMod.'))
